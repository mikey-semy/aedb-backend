...
from app.routers.v1 import main, auth, posts, manuals, sensors, converters
...
all_routers.include_router(converters.router, prefix=api_prefix)
all_routers.include_router(sensors.router, prefix=api_prefix)
